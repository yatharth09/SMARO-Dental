...
export default function NewTasksModal({show, setShow}: Props) {
                            ...
                            <Dialog.Panel
                               ...
                               <div className="w-full h-full grid grid-cols-3 px-20 py-5 pb-32">
                                    ...
                                    <LabelWithInput
                                        ...
                                        value={""}
                                    />
                                    <LabelWithInput label="Availability" width="276"  onChange={()=>{}}
                                        touched={false}
                                        value={""} />
                                    <LabelContainer label="User">
                                    <Select label="" width="17.25" onChange={()=>{}} options={[]}  />
                                    </LabelContainer>
                                        <LabelWithInput label="Due date"type="date" width="276"  onChange={()=>{}}
                                        touched={false}
                                        value={""} />
