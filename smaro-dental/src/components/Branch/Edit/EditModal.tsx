...
const EditModal: React.FC<Props> = ({show,branch,onSubmit,onClose}) => {
                        ...
                        >
                            <Dialog.Panel
                                ...
                                <div
                                    ...
                                    <button onClick={() => onClose("edit")} className="bg-[#6C757D] rounded-[4px] text-base font-semibold px-4 py-[10px]">
                                        Back
                                    </button>
                                    <button
                                        type="button"
